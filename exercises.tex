...
There is a converse to~(3.20.2):
\begin{prop}[3.20.2]
If \(A_1\times A_2\ne\emptyset\) and \(A_1\times A_2\) is open in \(E_1\times E_2\), then \(A_1\)~is open in~\(E_1\) and \(A_2\)~is open in~\(E_2\).
\end{prop}
\begin{proof}
If \(a_1\in A_1\) and \(a_2\in A_2\), then \(a=(a_1,a_2)\in A_1\times A_2\), so by the assumption and~(3.20.1) there is \(r>0\) with
\[B_1(a_1;r)\times B_2(a_2;r)=B(a;r)\subseteq A_1\times A_2\]
By a corrected version of~(1.3.2), \(B_1(a_1;r)\subseteq A_1\) and \(B_2(a_2;r)\subseteq A_2\). It follows that \(A_1\) and~\(A_2\) are open.
\end{proof}
\begin{rmk}
The requirement that \(A_1\times A_2\ne\emptyset\) is essential. For example, \([0,1)\times\emptyset=\emptyset\) is open in~\(\R^2\), but \([0,1)\)~is not open in~\(\R\). Also \(\emptyset\)~is closed in~\(\R^2\) but \([0,1)\)~is not closed in~\(\R\), contrary to~(3.20.3).
\end{rmk}

\section*{Chapter~IV}
\subsection*{Section~1}
\begin{rmk}
In the latter part of the proof of~(4.1.3), alternatively note for fixed \(x\in\R\) that the mappings
\[r\mapsto rx\mapsto f(rx)\qquad\text{and}\qquad r\mapsto rf(x)\]
are continuous from~\(\R\) to~\(\R\) by (4.1.2) and~(3.11.5), and agree on~\(\Q\), hence agree on~\(\R\) by the principle of extension of identities~(3.15.2).
\end{rmk}
